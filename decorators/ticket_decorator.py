...
from models.ticket import Ticket # Importuję klasę bazową Ticket, która jest komponentem dla dekoratorów.
...
class TicketDecorator(Ticket):
    ...
    def price(self):
        ...
        """
        return self._ticket.price  # Zwracam cenę opakowanego biletu.
    ...
    def screening(self):
        ...
        """
        return self._ticket.screening  # Zwracam seans opakowanego biletu.
    ...
    def seat(self):
        ...
        Deleguje wywołanie do opakowanego obiektu biletu.
        """
        return self._ticket.seat  # Zwracam miejsce opakowanego biletu.
...
class ThreeDTicketDecorator(TicketDecorator):
    ...
    def __init__(self, ticket: Ticket):
        ...
        """
        super().__init__(ticket)  # Wywołuję konstruktor klasy nadrzędnej (TicketDecorator), przekazując opakowany bilet.
    ...
    def price(self):
        ...
        """
        return self._ticket.price + 5  # Zwracam cenę opakowanego biletu powiększoną o 5 zł (koszt 3D).
    ...
    def __str__(self):
        ...
        """
        # Zwracam tekstową reprezentację opakowanego biletu i dodaję na końcu "[3D]".
...
class SnackComboTicketDecorator(TicketDecorator):
    ...
    def price(self):
        ...
        """
        return self._ticket.price + 15  # Zwracam cenę opakowanego biletu powiększoną o 15 zł (koszt zestawu przekąsek).
    ...
    def __str__(self):
        ...
        """
        # Zwracam tekstową reprezentację opakowanego biletu i dodaję na końcu "[+ Zestaw Przekąsek]".
